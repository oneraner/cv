export const frontend = {
  title: "Chih Yuan Chao (Jeff) - Senior Frontend Engineer",
  summary:
    "Senior Frontend Engineer with strong experience in React, Next.js, and modern web technologies. Skilled at bridging business needs with technical solutions and driving team productivity.",
  skills: [
    "JavaScript",
    "TypeScript",
    "React / Next.js",
      ...
      items: [
        ...
        },
        {
          ...
          details: [
            ...
            "Reduced profile form load time by 3s and CPU peaks by **50%**, resolving major UI latency issues.",
            "Used React Testing Library to set up tests, raising coverage from **0% to 45%+**.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "https://github.com/oneraner/cv",
        },
      ],
    },
    {
